...
import { Store, ShoppingBag, FileText, ArrowLeft, Loader2 } from "lucide-react";
              ...
              >
                ...
                <div className="flex gap-2 mt-3">
                  ...
                  <button
                    ...
                    className="flex-1 bg-emerald-100 text-emerald-700 px-3 py-2 rounded-xl font-bold text-xs hover:bg-emerald-200 transition-colors disabled:opacity-50 disabled:cursor-wait flex items-center justify-center gap-1"
                  >
