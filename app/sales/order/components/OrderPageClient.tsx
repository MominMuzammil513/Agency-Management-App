        ...
        {filteredProducts.map((product) => {
          ...
          return (
            <div
              ...
              className={`relative bg-white rounded-2xl shadow-sm border-2 border-transparent transition-all active:scale-95 duration-100 ${
                isOOS
            ...
            >
              ...
              {/* Image Container - 🔥 Updated for Next Image */}
              <div className="relative h-48 w-full mb-1 overflow-hidden flex items-center justify-center rounded-xl">
                {product.imageUrl ? (
                  <Image
                    src={product.imageUrl}
                    alt={product.name}
                    fill // Container ko fill karega
                    className="object-fill" // Fit rahega aur katega nahi
                    sizes="(max-width: 768px) 50vw, 33vw" // Performance Optimization
                  />
                ) : (
              ...
              {/* Info - 🔥 COMPACT ROW */}
              <div className="p-2.5">
                <h3 className="font-bold text-slate-800 text-balance leading-tight line-clamp-1 mb-1">
                  {product.name}
                </h3>
                {/* Stock Text */}
                <span
                ...
                {/* Price, Stock & Minus Button in One Row */}
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {qty > 0 && (
                      <button
                        ...
                        className="h-8 w-8 bg-red-50 border border-red-100 text-red-500 rounded-full flex items-center justify-center shadow-sm active:scale-90 transition-all"
                      >
